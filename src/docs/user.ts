...
export const userProfileDocs = {
                  ...
                  data: {
                    ...
                    properties: {
                      ...
                      profile_picture_url: {
                        type: "string",
                        example:
                          "https://ayyieaqvvurjnfoxvlzt.supabase.co/storage/v1/object/public/profile-pictures/59ca9083-5f5a-8888-ab3d-63aa48c10696_23482cf6-2222-40fb-ad10-jasdhjkasdhuw12.png",
                      },
                      resume_url: {
                        type: "string",
                        example:
                          "https://ayyieaqvvurjnfoxvlzt.supabase.co/storage/v1/object/public/resumes/59ca9083-5f5a-9ab2-ac7d-63aa48c10696_215ae0fd-f27f-45ce-9999-njcasu13w2134.pdf",
                      },
                    },
                  },
                },
  ...
  "/api/v1/user/update-profile-data": {
    put: {
      ...
      description:
        "Update user profile information (name, email, phone number)",
      tags: ["User Profile"],
      security: [
        {
          bearerAuth: [],
  ...
  "/api/v1/user/profile-picture": {
    put: {
      ...
      description:
        "Upload and update user profile picture with file validation",
      tags: ["User Profile"],
      security: [
        {
          bearerAuth: [],
                  ...
                  data: {
                    ...
                    properties: {
                      profile_picture_url: {
                        ...
                        example:
                          "https://your-supabase-url.supabase.co/storage/v1/object/public/profile-pictures/123_uuid-string.jpg",
                      },
                    },
                  },
                },
                  ...
                  data: {
                    ...
                    properties: {
                      profile_picture_url: {
                        ...
                        nullable: true,
                        description:
                          "Profile picture URL after deletion (will be null)",
                        example: null,
                      },
                    },
                  },
